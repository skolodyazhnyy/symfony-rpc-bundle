...
class ObjectTypeTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testExtractingFromLoadXML()
    {
        $expectedValues = array('fooName' => 'fooValue', 'barName' => 'barValue');

        $document = new \DOMDocument();
        $document->preserveWhiteSpace = false;
        $document->loadXML($this->getXML());

        $xmlStruct = $document->getElementsByTagName('struct')->item(0);
        ...
        $values = $typeInstance->extract($xmlStruct);
...
<member>
<name>fooName</name>
<value><test>fooValue</test></value>
</member>
<member>
<name>barName</name>
<value><test>barValue</test></value>
</member>
</struct></value>
</param>
</params>
